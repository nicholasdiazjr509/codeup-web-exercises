...
// Notice in the above example, lines 74 - 93 feature requests to the API nested within other requests. This is done due to the Asynchronus nature of our requests. To have them not nested, would result in the code below.
...
// The following doesn't work, and will make a David cry if you try it.

let jeff;
let doThisWork = fetch('https://pokeapi.co/api/v2/pokemon/mewtwo').then(response => response.json()).then(data => jeff = data);

console.log(doThisWork);
setTimeout(() => {
    console.log(jeff);
}, 3000);
// doThisWork.then(data => console.log(data));